...
- (void)setImageWithURL:(NSURL *)url usingActivityIndicatorStyle:(UIActivityIndicatorViewStyle)activityStyle {
    [self setImageWithURL:url placeholderImage:[UIImage imageNamed:@"defaultavatar"] options:0 progress:nil completed:nil usingActivityIndicatorStyle:activityStyle];
}
...
- (void)setImageDownloadWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder usingActivityIndicatorStyle:(UIActivityIndicatorViewStyle)activityStyle{
    [self setImageWithURL:url placeholderImage:placeholder options:SDWebImageLowPriority progress:nil completed:nil usingActivityIndicatorStyle:activityStyle];
